...
<body class="counter-scroll">
    ...
    <div class="container py-5">
        <div class="row align-items-center g-4">
            ...
            <div class="col-md-5 mb-4 mb-md-0">
                <img
                    src="../impactnest/image/new-images-changes/deck/deck-design.jpg"
                    alt="Team Discussion"
                    class="img-fluid"
            ...
            <div class="col-md-5">
                <p class="text-secondary" style="font-size: 14px; text-align: center; color: black !important; margin-top: 20px !important;">
                    At Impact Nest, we craft powerful, investor-ready pitch decks
                    and company profile that tell your story with clarity,
                    confidence, and impact. Whether you're raising your first round
                    or preparing for Series A, a well-designed deck can be the
                    difference between a missed opportunity and a signed term
                    sheet.
                    <br>
                <p class="text-secondary" style="font-size: 14px; text-align: center; color: black !important;">
                    We combine strategic messaging, compelling design, and
                    market-aligned content to ensure your deck speaks directly to
                    what investors care about — vision, traction, financials,
                    scalability, and the opportunity ahead.
                </p>
                </p>
            </div>
        </div>
    ...
    <div class="section-content" style="margin:auto;width: 95%; margin-top:-100px !important;">
        <div class="row g-4">
            ...
            <div class="col-md-4 col-lg-4">
                <div class="offer-card">
                    <div class="offer-icon">
                        <img src="../impactnest/image/new-icons/Narrative-Development.png" alt="Icon" />
                    </div>

                    <h5 class="offer-title">Narrative Development</h5>
                    <div class="divider"></div>

                    <p class="offer-description">We help define your story- who you are, the
                        problem you're solving, and why now is the
                        right time. We turn complex ideas into a
            ...
            <div class="col-md-4 col-lg-4">
                <div class="offer-card">
                    <div class="offer-icon">
                        <img src="../impactnest/image/new-icons/Visual-Design-&-Branding.png" alt="Icon" />
                    </div>

                    <h5 class="offer-title">Visual Design & Branding</h5>
                    <div class="divider"></div>

                    <p class="offer-description">Professional, clean, and modern design that
                        reflects your brand and grabs investor
                        attention. Every slide is visually structured
                        for clarity and flow.</p>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="offer-card">
                    <div class="offer-icon">
                        <img src="../impactnest/image/new-icons/Investor-Focused-Content.png" alt="Icon" />
                    </div>

                    <h5 class="offer-title">Investor-Focused Content</h5>
                    <div class="divider"></div>

                    <p class="offer-description">We highlight what matters most to investors
                        — market size, traction, business model,
                        financials, and use of funds — in a format
                        they trust.</p>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="offer-card">
                    <div class="offer-icon">
                        <img src="../impactnest/image/new-icons/Content-Strategy-&-Structuring.png" alt="Icon" />
                    </div>

                    <h5 class="offer-title">Content Strategy & Structuring</h5>
                    <div class="divider"></div>

                    <p class="offer-description">We organize your deck into a compelling
                        flow: Introduction → Problem → Solution →
                        Market → Business Model → Traction → Team
                        → Financials → Ask.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="offer-card">
                    <div class="offer-icon">
                        <img src="../impactnest/image/new-icons/Iterative-Support-&-Revisions.png" alt="Icon" />
                    </div>

                    <h5 class="offer-title">Iterative Support & Revisions</h5>
                    <div class="divider"></div>

                    <p class="offer-description">We collaborate closely, incorporating your
                        feedback and aligning the deck with investor
                        inputs and pitch rounds.</p>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="offer-card">
                    <div class="offer-icon">
                        <img src="../impactnest/image/new-icons/Multiple-Formats-&-Versions.png" alt="Icon" />
                    </div>

                    <h5 class="offer-title">Multiple Formats & Versions</h5>
                    <div class="divider"></div>

                    <p class="offer-description">Presentation-ready decks (for live pitches),
                        email decks (for cold outreach), and one-
                        pagers — tailored for different fundraising
                        scenarios.</p>
                </div>
            </div>
        </div>
    ...
    <section class="deck-section">
        <div class="container">
            <h2 style="font-size: 6rem !important ; color: #002c54; margin-bottom: 50px !important;">Why A Strong Deck Matters</h2>
            <div class="row g-4 justify-content-center">

                <div class="col-md-6 col-lg-3">
                    <div class="deck-icon mx-auto">
                        <img style="width: 40px; height: 40px;" src="../impactnest/image/new-icons/First-Impressions-Counts.png" alt="Impression Icon">
                    </div>
                    <div class="deck-title">First Impressions Counts</div>
                    <div style="width: auto; height: 4px; background-color: #002c54;"></div>

                    <div class="deck-text">Investors often make decisions based on the
                        first 5 slides.</div>
                </div>

                <div class="col-md-6 col-lg-3">
                    <div class="deck-icon mx-auto">
                        <img style="width: 40px; height: 40px;" src="../impactnest/image/new-icons/Tells-Your-Story-Effectively.png" alt="Story Icon">
                    </div>
                    <div class="deck-title">Tells Your Story Effectively</div>
                    <div style="width: auto; height: 4px; background-color: #002c54;"></div>

                    <div class="deck-text">A great deck simplifies and elevates your
                        message.</div>
                </div>

                <div class="col-md-6 col-lg-3">
                    <div class="deck-icon mx-auto">
                        <img style="width: 40px; height: 40px;" src="../impactnest/image/new-icons/Builds-Investor-Confidence.png" alt="Confidence Icon">
                    </div>
                    <div class="deck-title">Builds Investor Confidence</div>
                    <div style="width: auto; height: 4px; background-color: #002c54;"></div>

                    <div class="deck-text">Professionally presented data and visuals
                        create credibility.</div>
                </div>

                <div class="col-md-6 col-lg-3">
                    <div class="deck-icon mx-auto">
                        <img style="width: 40px; height: 40px;" src="../impactnest/image/new-icons/Drives-Action.png" alt="Action Icon">
                    </div>
                    <div class="deck-title">Drives Action</div>
                    <div style="width: auto; height: 4px; background-color: #002c54;"></div>

                    <div class="deck-text">A well-structured deck leads to more
                        meetings, better conversations, and faster
                        funding.</div>
                </div>
        ...
        <div class="inner-mobile-nav">
            ...
            <nav class="mobile-main-nav">
                <ul id="menu-mobile" class="menu">
                    <li>
                        <a href="../impactnest/index.php">Home
                        </a>
