...
<body class="counter-scroll">
    ...
    <div class="container py-5">
        <div class="row align-items-center g-4">
            ...
            <div class="col-md-5 mb-4 mb-md-0">
                <img
                    src="../impactnest/image/new-images-changes/modeling/modeling-meeting.jpg"
                    alt="Team Discussion"
                    class="img-fluid"
            ...
            <div class="col-md-5">
                <p class="text-secondary" style="font-size: 14px; text-align: center; color: black !important; margin-top: 20px !important;">
                    At Impact Nest, we build powerful, reliable, and investor-ready
                    financial models that bring structure to your growth story.
                    Whether you’re preparing for fundraising, planning market
                    expansion, or optimizing operations, our financial modelling
                    service delivers the insights, projections, and validation you
                    need to make bold, confident business decisions.
                    <br>
                <p class="text-secondary" style="font-size: 14px; text-align: center; color: black !important;">
                    Our models are not just spreadsheets - they’re strategic tools
                    designed to reflect your business realities, project future
                    performance, and communicate value to stakeholders and
                    investors.
                </p>
                </p>
            </div>
    ...
    <!-- <div class="detalis-content mb-40">
                            ...
                            <div class="mb-20">
                                ...
                                <div class="body-2 desc" style="letter-spacing:0.5px; line-height:1.8;">
                                    Tailored models that reflect your unique business model, revenue streams, and cost structures.
                                    We go beyond templates to build fully customized tools.
                                </div>
                            </div>
                            ...
                            <div class="mb-20">
                                ...
                                <div class="body-2 desc" style="letter-spacing:0.5px; line-height:1.8;">
                                    Accurate and dynamic forecasts that take into account market conditions, pricing strategies,
                                    operational scaling, and product growth.
                                </div>
                            </div>
                            ...
                            <div class="mb-20">
                                ...
                                <div class="body-2 desc" style="letter-spacing:0.5px; line-height:1.8;">
                                    We stress-test your assumptions with best-case, base-case, and worst-case outcomes —
                                    helping you plan for every possibility.
                                </div>
                            </div>
                            ...
                            <div class="mb-20">
                                ...
                                <div class="body-2 desc" style="letter-spacing:0.5px; line-height:1.8;">
                                    We help you estimate fair valuation ranges based on DCF (Discounted Cash Flow), multiples,
                                    or industry benchmarks — crucial for investor discussions.
                                </div>
                            </div>
                            ...
                            <div class="mb-20">
                                ...
                                <div class="body-2 desc" style="letter-spacing:0.5px; line-height:1.8;">
                                    Clean, easy-to-understand outputs aligned with investor expectations — including P&amp;L,
                                    Balance Sheet, Cash Flow, Cap Table, and Unit Economics.
                                </div>
                            </div>
                            ...
                            <div class="mb-20">
                                ...
                                <div class="body-2 desc" style="letter-spacing:0.5px; line-height:1.8;">
                                    We stay with you through pitch revisions, investor feedback, and multiple fundraising rounds —
                                    updating your model as your business evolves.
                                </div>
                            </div>
    ...
    <!-- what we offer financial modeling section -->
    ...
    <style>
        ...
        .offer-card {
            ...
            box-shadow: 0 0 10px rgba(11, 43, 64, 0.05);
            height: 100%;
    ...
    <!-- Section Content -->
    <div class="section-content " style="margin:auto;width: 95%; margin-top:-100px !important;">
        <div class="row g-4">
            <!-- Card 1 -->
            <div class="col-md-4 col-lg-4">
                <div class="offer-card">
                    <div class="offer-icon">
                        <img src="../impactnest/image/new-icons/Custom-Financial-Models.png" alt="Icon" />
                    </div>

                    <h5 class="offer-title">Custom Financial Models</h5>
                    <div class="divider"></div>

                    <p class="offer-description">Tailored models that reflect your unique
                        business model, revenue streams, and cost
                        structures. We go beyond templates to build
            ...
            <div class="col-md-4 col-lg-4">
                <div class="offer-card">
                    <div class="offer-icon">
                        <img src="../impactnest/image/new-icons/Revenue-&-Cost-Forecasting.png" alt="Icon" />
                    </div>

                    <h5 class="offer-title">Revenue & Cost Forecasting</h5>
                    <div class="divider"></div>

                    <p class="offer-description">Accurate and dynamic forecasts that take
                        into account market conditions, pricing
                        strategies, operational scaling, and product
                        growth.</p>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="offer-card">
                    <div class="offer-icon">
                        <img src="../impactnest/image/new-icons/Scenario-&-Sensitivity-Analysis.png" alt="Icon" />
                    </div>

                    <h5 class="offer-title">Scenario & Sensitivity Analysis</h5>
                    <div class="divider"></div>

                    <p class="offer-description">We stress-test your assumptions with best-
                        case, base-case, and worst-case outcomes —
                        helping you plan for every possibility.</p>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="offer-card">
                    <div class="offer-icon">
                        <img src="../impactnest/image/new-icons/Valuation-Support.png" alt="Icon" />
                    </div>

                    <h5 class="offer-title">Valuation Support</h5>
                    <div class="divider"></div>

                    <p class="offer-description">We help you estimate fair valuation ranges
                        based on DCF (Discounted Cash Flow),
                        multiples, or industry benchmarks — crucial
                        for investor discussions.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="offer-card">
                    <div class="offer-icon">
                        <img src="../impactnest/image/new-icons/Investor-Ready-Financials.png" alt="Icon" />
                    </div>

                    <h5 class="offer-title">Investor-Ready Financials</h5>
                    <div class="divider"></div>

                    <p class="offer-description">Clean, easy-to-understand outputs aligned
                        with investor expectations — including P&L,
                        Balance Sheet, Cash Flow, Cap Table, and
                        Unit Economics.</p>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="offer-card">
                    <div class="offer-icon">
                        <img src="../impactnest/image/new-icons/Model-Iteration-&-Review.png" alt="Icon" />
                    </div>

                    <h5 class="offer-title">Model Iteration & Review</h5>
                    <div class="divider"></div>

                    <p class="offer-description">We stay with you through pitch revisions,
                        investor feedback, and multiple fundraising
                        rounds — updating your model as your
                        business evolves.</p>
                </div>
            </div>
        </div>
                ...
                <div class="process-item step-hover active">
                    ...
                    <div class="process-content">
                        ...
                        <div class="desc wow fadeInUp animated" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                            Test assumptions, identify weak spots, and prepare for market fluctuations.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="deck-section">
        <div class="container">
            <h2 style="font-size: 6rem !important ; color: #002c54; margin-bottom: 50px !important;">Why Financial Modelling Matters</h2>
            <div class="row g-4 justify-content-center">

                <div class="col-md-6 col-lg-3">
                    <div class="deck-icon mx-auto">
                        <img style="width: 40px; height: 40px;" src="../impactnest/image/new-icons/Informed-Decision-Making.png" alt="Impression Icon">
                    </div>
                    <div class="deck-title">Informed Decision-Making</div>
                    <div style="width: auto; height: 4px; background-color: #002c54;"></div>

                    <div class="deck-text">Make smarter business and fundraising
                        decisions based on real data and sound
                        projections.</div>
                </div>

                <div class="col-md-6 col-lg-3">
                    <div class="deck-icon mx-auto">
                        <img style="width: 40px; height: 40px;" src="../impactnest/image/new-icons/Investor-Confidence.png" alt="Story Icon">
                    </div>
                    <div class="deck-title">Investor Confidence</div>
                    <div style="width: auto; height: 4px; background-color: #002c54;"></div>

                    <div class="deck-text">Well-structured models build credibility and
                        trust in your numbers.</div>
                </div>

                <div class="col-md-6 col-lg-3">
                    <div class="deck-icon mx-auto">
                        <img style="width: 40px; height: 40px;" src="../impactnest/image/new-icons/Strategic-Planning.png" alt="Confidence Icon">
                    </div>
                    <div class="deck-title">Strategic Planning</div>
                    <div style="width: auto; height: 4px; background-color: #002c54;"></div>

                    <div class="deck-text">Align team goals, funding needs, and
                        operational execution to a financial
                        roadmap.</div>
                </div>

                <div class="col-md-6 col-lg-3">
                    <div class="deck-icon mx-auto">
                        <img style="width: 40px; height: 40px;" src="../impactnest/image/new-icons/Risk-Management.png" alt="Action Icon">
                    </div>
                    <div class="deck-title">Risk Management</div>
                    <div style="width: auto; height: 4px; background-color: #002c54;"></div>

                    <div class="deck-text">Test assumptions, identify weak spots, and
                        prepare for market fluctuations</div>
                </div>
                    ...
                    <li class="menu-item menu-item-has-children-mobile">
                        ...
                        <div id="dropdown-menu-3" class="collapse" data-bs-parent="#menu-mobile">
                            <ul class="sub-menu-mobile">
                                ...
                                <li class="menu-item"><a href="../impactnest/financial-modeling.php">Financial modeling</a></li>
