...
<body class="counter-scroll">
    ...
    <div class="wrapper">
        ...
        <div class="section-team page-team" style="margin:50px"> <!-- tf-spacing-3-->
            <div class="tf-container">
                <div class="row">
                    <div class="col-12">
            ...
            <div class="tf-container">
                <div class="row rg-30 text-center">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-item hover-img">
                            <div class="image">
                                <img id="image-size" src="image/team-item/team-item-10.jpg"  data-src="image/team-item/team-item-10.jpg" alt="" class=" ls-is-cached lazyloaded">
                                <a href="#canvnasTeamsDetails" data-bs-toggle="offcanvas" class="link"></a>
                                <div class="team-social p-3 color-white" style="backdrop-filter: blur(10px);">
                                    <p class="contentSize">
...
insight, he helps ventures secure funding and scale with clarity, confidence, and long-term vision.
                            ...
                            <div class="team-contet">
                                ...
                                <div class="position caption-1 contentSize" style="text-align:center">
                                    Director
                                </div>
                            </div>
                        </div>
...
access capital, and build strong foundations for long-term success.
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-item hover-img">
                            <div class="image">
                                <img id="image-size" src="image/team-item/team-item-4.jpg"  data-src="image/team-item/team-item-10.jpg" alt="" class=" ls-is-cached lazyloaded">
                                <a href="#canvnasTeamsDetails" data-bs-toggle="offcanvas" class="link"></a>
                                <div class="team-social p-3 color-white" style="backdrop-filter: blur(10px);">
                                    <p class="contentSize">
...
each venture is equipped to scale effectively and attract the right capital.
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-item hover-img">
                            <div class="image">
                                <img id="image-size" src="image/team-item/team-item-13.jpg"  data-src="image/team-item/team-item-13.jpg" alt="" class=" ls-is-cached lazyloaded">
                                <a href="#canvnasTeamsDetails" data-bs-toggle="offcanvas" class="link"></a>
                                <div class="team-social p-3 color-white" style="backdrop-filter: blur(10px);">
                                    <p class="contentSize">
        ...
        <div class="inner-mobile-nav">
            ...
            <nav class="mobile-main-nav">
                <ul id="menu-mobile" class="menu">
                    <li>
                        <a href="../fundraise/index.php">Home
                        </a>

                    </li>
                    <li>
                        <a href="../fundraise/about-us.php">About
                        </a>
                    </li>
                    ...
                    <div class="col-12">
                        <div class="top-content">
                            <div class="logo-search">
                                <a href="../fundraise/index.php">
                                    <img src="../fundraise/image/logo/logo.svg" alt="">
                                </a>
                            </div>
            ...
            <nav class="mobile-main-nav">
                <ul id="menu-mobile" class="menu">
                    ...
                    <li class="menu-item menu-item-has-children-mobile">
                        ...
                        <div id="dropdown-menu-3" class="collapse" data-bs-parent="#menu-mobile">
                            <ul class="sub-menu-mobile">
                                <li class="menu-item"><a href="../fundraise/our-services-1.php">Fund Raising</a></li>
                                <li class="menu-item"><a href="../fundraise/tailored-strategies.php">Tailored Strategies</a></li>
                                <li class="menu-item"><a href="../fundraise/financial-modelling.php">Financial Modelling</a></li>
                                <li class="menu-item"><a href="../fundraise/Investor-pitch-desck-design.php">Desk Design</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
                        <a href="../fundraise/our-teams-industry.php">Team</a>

                    </li>
                    <li>
                        <a href="../fundraise/our-expert.php">Our Experts</a>
                    </li>
                    <li>
                        <a href="../fundraise/contact-us.php">Contact</a>
                    </li>
                </ul>
                <div class="contact-mobile">
                    <h6 class="title-contact-mobile">Contact Info</h6>
