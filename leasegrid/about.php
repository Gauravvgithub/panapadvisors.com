...
<body class="custom-cursor">
    ...
    <section class="about-main-section" style="padding: 50px 0 30px 0; background: #f9f9fb; text-align: justify;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <h3 style="color: var(--uniqo-primary); margin-bottom: 18px;">Our Story</h3>
                    <p style="font-size: 1.1rem; color: #333;">Leasegrid is a company decked with veteran professionals who provide unparalleled leasing solutions. We provide complete Asset Lifecycle Solutions, tailored to suit client's requirements. No matter what asset class you need to procure, we can assist you by customizing our solutions to help you optimize your cash flow. Whether you are looking for Plant and Machinery, servers, furniture, electronics devices or any other kind of asset, Leasegrid can provide it to you on lease. Leasegrid is one of the providers of comprehensive leasing solutions for all your requirements.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="why-choose-section-two about-why-choose">
        <div class="container">
            <div class="why-choose-image-two">
                <img src="assets/images/why-choose/why-choose-two-1.png" alt="why-choose" class="animate zoomIn wow" data-wow-duration="2500ms">
            </div>
            <div class="row">
                <div class="col-lg-6 m-auto">
                    <div class="heading-box light text-center">
                        ...
                        <h2 class="heading-title animate fadeInUp wow" data-wow-duration="1500ms" data-wow-delay="200ms">Achieving Growth Through <span>Collaboration</span></h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="why-choose-left-two">
                        ...
                        <div class="why-choose-box-two animate fadeInUp wow" data-wow-duration="1500ms" data-wow-delay="400ms">
                            ...
                            <p>We specialize in serving specific industries, such as healthcare, finance, or
                                manufacturing, and offer tailored solutions.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="why-choose-right-two">
                        <div class="why-choose-box-two animate fadeInRight wow" data-wow-duration="1500ms" data-wow-delay="200ms">
                            ...
                            <p>We stay up to date with the latest technology trends & offer innovative solutions that
                        ...
                        <div class="why-choose-box-two animate fadeInRight wow" data-wow-duration="1500ms" data-wow-delay="400ms">
                            ...
                            <p>Our solutions are scalable and can grow with your business, ensuring that you get the
    ...
    <!-- testimonial one end -->
    <div class="why-choose-five-two about-why-choose-two">
        <div class="container">
            <div class="row gutter-y-40">
                ...
                <div class="col-lg-8">
                    <div class="why-choose-right-five">
                        <div class="row gutter-y-30">
                            <div class="col-lg-4 col-md-4">
                                <div class="why-choose-box-five-two animate fadeInRight wow" data-wow-duration="1500ms" data-wow-delay="200ms">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="why-choose-box-five-two animate fadeInRight wow" data-wow-duration="1500ms" data-wow-delay="400ms">
                                    <div class="why-choose-box-icon">
                                        <div class="circleGraphic" data-circle-options='{
                                           "color": "#C9A885",
                                           "value": 70
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="why-choose-box-five-two animate fadeInRight wow" data-wow-duration="1500ms" data-wow-delay="600ms">
                                    <div class="why-choose-box-icon">
                                        <div class="circleGraphic" data-circle-options='{
                                           "color": "#C9A885",
                                           "value": 65
